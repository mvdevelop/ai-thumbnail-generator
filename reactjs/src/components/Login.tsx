    ...
    <>
      ...
      <div className="min-h-screen w-full flex items-center justify-center bg-slate-950 p-4 relative overflow-hidden">
        <form
          ...
          <div className="flex items-center mt-4 w-full bg-white/5 ring-1 ring-white/10 focus-within:ring-pink-500/60 h-12 rounded-full overflow-hidden pl-6 gap-2 transition-all">
          ...
          <button type="submit" className="mt-6 w-full h-11 rounded-full text-white bg-pink-600 hover:bg-pink-500 transition font-medium">
            {state === "login" ? "Login" : "Sign up"}
          </button>
