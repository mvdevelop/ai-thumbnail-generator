...
function Login() {
  ...
  return (
    /* Container Principal: Garante centralização vertical e horizontal */
    <div className="min-h-screen w-full flex items-center justify-center bg-slate-950 p-4 relative overflow-hidden">
      
      <form
        onSubmit={handleSubmit}
        // Ajustado: max-w-md para garantir que não fique gigante em telas grandes e z-10 para ficar acima do fundo
        className="relative z-10 w-full max-w-[350px] text-center bg-white/5 border border-white/10 rounded-2xl px-8 backdrop-blur-sm shadow-2xl">
        ...
        {state !== "login" && (
          <div className="flex items-center mt-6 w-full bg-white/5 ring-1 ring-white/10 focus-within:ring-indigo-500/60 h-12 rounded-full overflow-hidden pl-6 gap-2 transition-all">
        ...
        <div className="flex items-center w-full mt-4 bg-white/5 ring-1 ring-white/10 focus-within:ring-indigo-500/60 h-12 rounded-full overflow-hidden pl-6 gap-2 transition-all">
        ...
        <div className="flex items-center mt-4 w-full bg-white/5 ring-1 ring-white/10 focus-within:ring-indigo-500/60 h-12 rounded-full overflow-hidden pl-6 gap-2 transition-all">
        ...
        <button type="submit" className="mt-6 w-full h-11 rounded-full text-white bg-indigo-600 hover:bg-indigo-500 transition font-medium">
          {state === "login" ? "Login" : "Sign up"}
        </button>
